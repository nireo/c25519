...
static uint64_t mask52(void) { return ((uint64_t)1 << 52) - 1; }
...
static fe random_weird_fe(void) {
  fe x;
  size_t i0 =
      (size_t)(rng_u64() % (sizeof(weird_limbs52) / sizeof(weird_limbs52[0])));
  size_t i1 =
      (size_t)(rng_u64() % (sizeof(weird_limbs51) / sizeof(weird_limbs51[0])));
  size_t i2 =
      (size_t)(rng_u64() % (sizeof(weird_limbs51) / sizeof(weird_limbs51[0])));
  size_t i3 =
      (size_t)(rng_u64() % (sizeof(weird_limbs51) / sizeof(weird_limbs51[0])));
...
static int is_in_bounds(const fe *x) {
  return bits_len64(x->l0) <= 52 && bits_len64(x->l1) <= 52 &&
         bits_len64(x->l2) <= 52 && bits_len64(x->l3) <= 52 &&
         bits_len64(x->l4) <= 52;
}
