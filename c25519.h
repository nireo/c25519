...
static inline void ed_private_to_public(const ed_private_key *sk,
                                        ed_public_key *pk) {
  memcpy(*pk, (*sk) + 32, 32);
}
...
static inline int ed25519_dom2(sha512_ctx *ctx, uint8_t phflag,
...
static inline int ed25519_public_key_from_seed(ed25519_public_key *pk,
...
static inline int ed25519_keypair_from_seed(ed25519_public_key *pk,
...
static inline int ed25519_keypair(ed25519_public_key *pk,
                                  ed25519_private_key *sk) {
  ed25519_seed seed;
...
static inline void
ed25519_public_key_from_private(ed25519_public_key *pk,
                                const ed25519_private_key *sk) {
  memcpy(*pk, (*sk) + ED25519_SEED_SIZE, ED25519_PUBLIC_KEY_SIZE);
}

static inline int ed25519_sign(ed25519_signature sig, const uint8_t *msg,
                               size_t msg_len, const ed25519_private_key *sk) {
...
static inline int ed25519_sign_from_seed(ed25519_signature sig,
  ...
  memcpy(sk, seed, ED25519_SEED_SIZE);
  memcpy(sk + ED25519_SEED_SIZE, pk, ED25519_PUBLIC_KEY_SIZE);
  const ed25519_private_key *skp =
      (const ed25519_private_key *)(const void *)&sk;
  return ed25519_sign(sig, msg, msg_len, skp);
}

static inline int ed25519_sign_ph(ed25519_signature sig, const uint8_t *msg,
                                  size_t msg_len, const ed25519_private_key *sk,
                                  const uint8_t *ctx_data, size_t ctx_len) {
...
static inline int ed25519_sign_ph_from_seed(ed25519_signature sig,
                                            const uint8_t *msg, size_t msg_len,
                                            const ed25519_seed seed,
...
static inline int ed25519_verify(const ed25519_signature sig,
                                 const uint8_t *msg, size_t msg_len,
...
static inline int ed25519_verify_ph(const ed25519_signature sig,
                                    const uint8_t *msg, size_t msg_len,
                                    const ed25519_public_key *pk,
                                    const uint8_t *ctx_data, size_t ctx_len) {
  if (msg_len != ED25519_SHA512_SIZE) {
