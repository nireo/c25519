...
static inline proj_cached *proj_cached_select(proj_cached *v,
                                              const proj_cached *a,
                                              const proj_cached *b, int cond) {
...
static inline affine_cached *affine_cached_select(affine_cached *v,
                                                  const affine_cached *a,
                                                  const affine_cached *b,
                                                  int cond) {
  fe_select(&v->YplusX, &a->YplusX, &b->YplusX, cond);
  fe_select(&v->YminusX, &a->YminusX, &b->YminusX, cond);
  fe_select(&v->T2d, &a->T2d, &b->T2d, cond);
...
static inline proj_p1xp1 *proj_p1xp1_add_affine(proj_p1xp1 *v, const point *p,
                                                const affine_cached *q) {
  fe YplusX;
  fe YminusX;
  fe PP;
  fe MM;
...
static inline proj_p1xp1 *proj_p1xp1_sub_affine(proj_p1xp1 *v, const point *p,
                                                const affine_cached *q) {
  fe YplusX;
  fe YminusX;
  fe PP;
...
static inline proj_lookup_table *proj_lookup_table_from_p3(proj_lookup_table *v,
                                                           const point *q) {
...
static inline affine_lookup_table *
affine_lookup_table_from_p3(affine_lookup_table *v, const point *q) {
...
static inline naf_lookup_table5 *naf_lookup_table5_from_p3(naf_lookup_table5 *v,
                                                           const point *q) {
  proj_cached_from_p3(&v->points[0], q);
  point q2;
  point_add(&q2, q, q);
...
static inline naf_lookup_table8 *naf_lookup_table8_from_p3(naf_lookup_table8 *v,
                                                           const point *q) {
  affine_cached_from_p3(&v->points[0], q);
  point q2;
  point_add(&q2, q, q);
...
static inline proj_cached *
proj_lookup_table_select_into(proj_cached *dest, const proj_lookup_table *v,
                              int8_t x) {
...
static inline affine_cached *
affine_lookup_table_select_into(affine_cached *dest,
                                const affine_lookup_table *v, int8_t x) {
  int8_t xmask = (int8_t)(x >> 7);
  uint8_t xabs = (uint8_t)((x + xmask) ^ xmask);
...
static inline proj_cached *
naf_lookup_table5_select_into(proj_cached *dest, const naf_lookup_table5 *v,
                              int8_t x) {
...
static inline affine_cached *
naf_lookup_table8_select_into(affine_cached *dest, const naf_lookup_table8 *v,
                              int8_t x) {
  *dest = v->points[(uint8_t)x / 2];
  return dest;
}
